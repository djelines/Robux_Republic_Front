...
export default function AppLayout({ children }) {
  ...
  const links = [
    ...
    },
    {
      ...
      href: "/beneficiary",
      icon: (
        <Contact className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
      ),
    },
    {
      label: "Dépot",
    ...
    },
    {
      ...
      icon: (
        <ArrowRightLeft className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
      ),
    },
  ];
  ...
  return (
    <div className="bg-white dark:bg-gray-950">
      ...
      >
        ...
        <div className="flex-1 flex flex-col relative bg-gray-50 dark:bg-gray-950">
          <div
            className={cn(
